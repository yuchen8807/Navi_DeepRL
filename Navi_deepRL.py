...
def main():
    ...
    parser.add_argument('--exploration_steps', default=10000, type=int, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--num_samples', default=10000, type=int, help='Number of training samples from the environment in training')
    #image:
    ...
    parser.add_argument('--target_update_freq', default=100, type=int, help='The frequency with which the target network is updated')
    parser.add_argument('--train_freq', default=4, type=int, help='The frequency of actions wrt Q-network update')
    parser.add_argument('--save_freq', default=100, type=int, help='The frequency with which the network is saved')
    parser.add_argument('--eval_freq', default=100, type=int, help='The frequency with which the policy is evlauted')
    parser.add_argument('--num_burn_in', default=500, type=int, help='Number of steps to populate the replay memory before training starts')
    ...
    parser.add_argument('--ddqn', default=True, dest='ddqn', action='store_true', help='enable double dqn')
